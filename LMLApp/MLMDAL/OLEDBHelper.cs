...
namespace LMLApp
{
    public sealed class OleDbHelper
    {
        ...
        public static DataTable ExecuteDataTable(String connectionString, bool isProc, string commandText)
        {
            if( connectionString == null || connectionString.Length == 0 ) throw new ArgumentNullException( "connectionString" );
            ...
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return ExecuteDataTable(connection, isProc, commandText);
            }
        }
        ...
        public static DataTable ExecuteDataTable(OleDbConnection connection, bool isProc, string commandText)
        {
            // Pass through the call providing null for the set of OleDbParameters
            if(isProc)
                return ExecuteDataTable(connection, CommandType.StoredProcedure, commandText, (OleDbParameter[])null);
            else
            {
                return ExecuteDataTable(connection, CommandType.Text, commandText, (OleDbParameter[])null);
            }
        }
        ...
        //This Perticular  method id custom, made by Ataur Rahaman
        /// <summary>
        /// 
        /// </summary>
         /// <param name="connection">A valid OleDbConnection</param>
        ...
        //        return OleDbHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName, commandParameters);
        //    }
        //    else
        //    {
        //        return OleDbHelper.ExecuteXmlReader(connection, CommandType.StoredProcedure, spName);
        //    }
        //}
        ...
        //        return OleDbHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName, commandParameters);
        //    }
        //    else
        //    {
        //        return OleDbHelper.ExecuteXmlReader(transaction, CommandType.StoredProcedure, spName);
        //    }
        //}
        //#endregion
    }
